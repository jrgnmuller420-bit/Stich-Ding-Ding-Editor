...
export const IconWand: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 00-5.78 1.128 2.25 2.25 0 01-2.4 2.245 4.5 4.5 0 008.4-2.245c0-.399-.078-.78-.22-1.128zm0 0a15.998 15.998 0 003.388-1.62m-5.043-.025a15.998 15.998 0 011.622-3.385m5.043.025a15.998 15.998 0 001.622-3.385m3.388 1.62a15.998 15.998 0 00-1.62-3.385m-5.044-.025a15.998 15.998 0 01-3.388-1.621m-1.62.025a15.998 15.998 0 01-3.385 1.622m3.385-1.622a15.998 15.998 0 00-3.385 1.622m-1.622-.025a15.998 15.998 0 011.622 3.385m3.388-1.62a15.998 15.998 0 00-1.62 3.385m-5.043.025a15.998 15.998 0 01-1.622 3.385" />
    </Icon>
);

export const IconEnhance: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <Icon {...props}>
...
export const IconEraser: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M11.25 4.5l-7.5 7.5 7.5 7.5m0-15l7.5 7.5-7.5 7.5" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.875 9.75l.375.375m-1.5-1.5l.375.375m-1.5-1.5l.375.375m-1.5-1.5l.375.375M21 12.375l.375.375m-1.5-1.5l.375.375m-1.5-1.5l.375.375m-1.5-1.5l.375.375m-1.5 1.5l.375.375M6.375 9.75l.375.375m-1.5-1.5l.375.375m-1.5-1.5l.375.375m-1.5-1.5l.375.375m-1.5 1.5l.375.375M3 12.375l.375.375m-1.5-1.5l.375.375m-1.5-1.5l.375.375m-1.5-1.5l.375.375" />
...
export const IconReplace: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0011.664 0l3.181-3.183m-11.664 0l3.181-3.182m-3.181 3.182L6.341 6.341m6.341 6.341l-3.182-3.182" />
    </Icon>
);

export const IconImagePlus: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}>
...
export const IconRefresh: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0011.664 0l3.181-3.183m-11.664 0l3.181-3.182m-3.181 3.182L6.341 6.341" />
    </Icon>
);

export const IconBrush: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props} fill="currentColor">
        <path d="M13.5 6.375c0-1.036.84-1.875 1.875-1.875h.375c1.036 0 1.875.84 1.875 1.875v1.875c0 1.036-.84 1.875-1.875 1.875h-.375a1.875 1.875 0 01-1.875-1.875V6.375z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M5.25 10.5v5.25a2.25 2.25 0 002.25 2.25h9a2.25 2.25 0 002.25-2.25v-5.25" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M15 6.375c.621 0 1.125-.504 1.125-1.125a1.125 1.125 0 00-2.25 0c0 .621.504 1.125 1.125 1.125z" />
    </Icon>
);

export const IconSelect: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 3.75v4.5m0-4.5h4.5m-4.5 0L9 9M20.25 20.25v-4.5m0 4.5h-4.5m4.5 0L15 15M3.75 20.25h4.5m-4.5 0v-4.5m11.25-11.25h4.5m-4.5 0v4.5" />
    </Icon>
);
